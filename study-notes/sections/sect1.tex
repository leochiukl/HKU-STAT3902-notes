...
Consider a ``population random variable'' \(X\) with a cdf \(F\). Then, a
...
\(X_1,\dotsc,X_n\) are independent and identically distributed with the common
cdf \(F\), denoted by \(X_1,\dotsc,X_n\iid F\).
\begin{center}
\begin{tikzpicture}
