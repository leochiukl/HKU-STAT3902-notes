...
title={Low bias \& low variance}, axis lines=middle]
...
\begin{tikzpicture}
\begin{axis}[xmin=-1, xmax=1, ymin=-1, ymax=1, xtick=\empty, ytick=\empty,
title={High bias \& low variance}, axis lines=middle]
\addplot [blue, only marks, mark=x] table {
0.5 0.6
0.51 0.42
0.5 0.53
...
\begin{tikzpicture}
\begin{axis}[xmin=-1, xmax=1, ymin=-1, ymax=1, xtick=\empty, ytick=\empty,
title={Low bias \& high variance}, axis lines=middle]
\addplot [blue, only marks, mark=x] table {
0.5 -0.5
0.31 0.2
-0.4 0.3
...
\begin{tikzpicture}
\begin{axis}[xmin=-1, xmax=1, ymin=-1, ymax=1, xtick=\empty, ytick=\empty,
title={High bias \& high variance}, axis lines=middle]
\addplot [blue, only marks, mark=x] table {
0.5 0.5
0.31 0.2
0.4 0.3
...
\]
\begin{remark}
\item \(\E_{\theta}[\cdot]\) and \(\mathbb{P}_{\theta}(\cdot)\) respectively
