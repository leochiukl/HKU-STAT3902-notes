...
\defn{frequentist inference}.  For statistical inference that assumes
\(\theta\) is an unknown \emph{random variable}, it is called \defn{Bayesian
inference} (which will not be discussed here).
\end{note}
